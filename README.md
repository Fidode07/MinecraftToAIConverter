...
4. After that go to the page [https://pytorch.org/get-started/locally/](https://pytorch.org/get-started/locally/){:target="_blank" rel="noopener"}, choose what you need and then execute the command that the page gave you
